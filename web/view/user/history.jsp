<%-- 
    Document   : history
    Created on : Jul 4, 2024, 4:20:24 PM
    Author     : PMQUANG
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Order History - Koparion</title>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="order" items="${orderList}">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="userbillDetails?action=view&orderId=${order.id}&account=${order.getUsername()}" class="btn btn-primary btn-sm">View</a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
