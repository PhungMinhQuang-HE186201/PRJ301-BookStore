<%-- 
    Document   : register
    Created on : Jun 28, 2024, 11:05:19 PM
    Author     : PMQUANG
--%>
...
<html class="no-js" lang="en">
    ...
    <body class="register">
        ...
        <jsp:include page="../common/authen/breadcrumbs-register-area.jsp"></jsp:include>
                        ...
                        <div class="offset-lg-2 col-lg-8 col-md-12 col-12">
                            <div class="billing-fields">
                                <div class="single-register">
                                    <form action="authen?action=signUp" method="POST" id="signUpForm">
                            ...
                            <a href="authen?action=login" style="color: orange;">Login</a>
