<%-- 
    Document   : lostPass
    Created on : Aug 4, 2024, 5:05:04 PM
    Author     : PMQUANG
--%>
...
<html class="no-js" lang="en">
    ...
    <body class="login">
        ...
        <jsp:include page="../common/authen/breadcrumbs-login-area.jsp"></jsp:include>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="offset-lg-3 col-lg-6 col-md-12 col-12">
                            <form action="authen?action=lostPass" method="post">
                                <div class="login-form">
                                    ...
                                    <div class="single-login single-login-2">
                                        <a href="#" onclick="return this.closest('form').submit()">Submit</a>
                                    </div>
