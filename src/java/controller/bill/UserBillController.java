...
public class UserBillController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UserBillController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UserBillController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector<Order> orderList = orderdao.getOrdersByAccountId(acc.getId());

        // Đặt danh sách đơn hàng vào request
        request.setAttribute("orderList", orderList);

        // Chuyển tiếp tới trang myaccount.jsp
