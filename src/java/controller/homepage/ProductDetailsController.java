...
public class ProductDetailsController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Category category = new Category(cate_id);
        //lay product tu database
        Product productFounded = productDao.findByID(product);
        Category categoryFounded = categoryDao.findByID(category);
        //set product chuyen sang product-details.jsp
        HttpSession session = request.getSession();
        session.setAttribute("productFounded", productFounded);
        session.setAttribute("categoryFounded", categoryFounded);
